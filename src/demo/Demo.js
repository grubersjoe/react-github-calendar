  ...
  <div>
    <header>
      <div className="container">
        ...
        <div>
          <small>
            Made with <span style={{ margin: '0 0.2em' }}>❤</span> by{' '}
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <code>react-tooltip</code> and use it as child of this component. See below example.
              </td>
            </tr>
            <tr>
              <td>years</td>
              ...
              <td>
                List of to be rendered years. Defaults to the current year. If no data is available
                the chart for this year will be ommited.
              </td>
            </tr>
          </tbody>
        </table>
...
<GitHubCalendar username="{username}" theme="{defaultTheme}" />`}
      ...
      <p>
        ...
        enable the `html` property in the <code>ReactTooltip</code> component to display the message
        correctly.
      </p>
      <pre>
        {`<div>
